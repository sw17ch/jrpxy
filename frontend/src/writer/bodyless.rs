//! Frontend wrappers around [`jrpxy_body::writer::bodyless`]. Each state
...
impl<I> Ready<I> {
    ...
    /// `length == 0`; positive lengths surface as
    /// [`BodyError::BodyOverflow`](jrpxy_body::error::BodyError::BodyOverflow).
